			...
			<div id="main">
				...
				<div id="content">
					...
					<div class="imgeviewer">
                    	<form action='{{url("update-txt?route={$route}")}}' method="POST" enctype="multipart/form-data" target="_self">
							@csrf
                            <div class="viewfooter">
                            <div>
                            <textarea name="text" id="" cols="30" rows="10">{{$text_info['text']}}</textarea>
